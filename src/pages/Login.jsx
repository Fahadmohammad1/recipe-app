...
const Login = () => {
  ...
  if (eError) {
    return (
      <div>
        <p>Error: {eError.message}</p>
      </div>
    );
  }
  return (
    <div className="max-w-[280px] mx-auto h-screen">
      <div className="flex flex-col items-center mt-[10vh]">
        <h2 className="mb-5 text-extra font-mono font-bold text-xl">
        ...
        <form>
          ...
          <button
            ...
            className="bg-[#7469B6] hover:bg-slate-700 text-white text-base rounded-lg py-2.5 px-5 transition-colors w-full text-[19px]"
          >
            Login
          </button>
        </form>
